...
-- Παρ 27 Σεπ 2019 11:17:17 μμ EEST
...
-- -----------------------------------------------------
-- Table `freebay`.`Message_Header`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `freebay`.`Message_Header` ;

CREATE TABLE IF NOT EXISTS `freebay`.`Message_Header` (
  `Id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `freebay`.`Message` (
  `Id` INT NOT NULL AUTO_INCREMENT,
  `Message_Header_Id` INT NOT NULL,
  ...
  INDEX `fk_Message_table11_idx` (`Message_Header_Id` ASC),
  PRIMARY KEY (`Id`),
  INDEX `fk_Message_User1_idx` (`Sender_Id` ASC),
  INDEX `fk_Message_User2_idx` (`Receiver_Id` ASC),
  CONSTRAINT `fk_Message_table11`
    FOREIGN KEY (`Message_Header_Id`)
    REFERENCES `freebay`.`Message_Header` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `freebay`.`Notification`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `freebay`.`Notification` ;

CREATE TABLE IF NOT EXISTS `freebay`.`Notification` (
  `Id` INT NOT NULL AUTO_INCREMENT,
  `User_Id` INT NOT NULL,
  `Content` VARCHAR(100) NOT NULL,
  `Link` VARCHAR(100) NOT NULL,
  `Status` ENUM('Read', 'Unread') NOT NULL,
  `Type` ENUM('Message', 'Auction') NOT NULL,
  `Time` DATETIME NOT NULL,
  PRIMARY KEY (`Id`),
